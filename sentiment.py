...
colorama.init()
print(f"{Fore.CYAN}Welcome to clanker.ai🥀{Style.RESET_ALL}")
user_name = input(f"{Fore.MAGENTA}Please enter your name: {Style.RESET_ALL} ").strip()
if not user_name:
    user_name = "anonymous user" 
conversation_history = []
print(f"\n{Fore.CYAN}Hello, {user_name}")
print(f"Type a sentence and I'll analyze your sentences with TextBlob and show you the sentiment/emotion.")
